...
function ProductCard({ product }) {
  ...
  return (
    ...
    >
      ...
      {/* <button className="absolute top-5 right-3 bg-white p-2 rounded-full shadow hover:text-red-500 z-10">
        <FaHeart />
      </button> */}
      ...
      <div className="overflow-hidden w-full">
        ...
        <img
          src={product.image?.[0]}
          alt={product.title}
          className="w-full h-42 sm:h-46 md:h-45 lg:h-75 object-scale-down transform duration-500 ease-in-out transition "
        />
